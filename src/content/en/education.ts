...
export const education: EducationItem[] = [
  {
    ...
    description:
      "Practical backend content with Node.js, API integration, and service-oriented implementation.",
    institution: "EBAC",
    status: "In progress",
  ...
  },
  {
    ...
    description:
      "Hands-on front-end training covering reusable components, responsiveness, and engineering best practices.",
    institution: "EBAC",
    status: "Completed",
  ...
  },
  {
    ...
    description:
      "Specialization focused on application architecture, APIs, and modern development practices.",
